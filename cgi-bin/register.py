...
mod = form.getvalue('mod')[2:len(form.getvalue('mod'))-2]
encPass = form.getvalue('encr')
...
httpServ.request('GET', '../src/reg.php?uid=%s&pw=%s&mod=%s&priv=%s' % (uName, pswrd, mod, private))
